...
export const home = {
  ...itHome,
  metadata: {
    title: 'DentVitalis – Dentists in Croatia',
    description: t(1, 6, 4)
      .split(/(?<=[.!?])\s+/)
      .slice(0, 2)
      .join(' '),
  ...
  hero: {
    ...itHome.hero,
    eyebrowAccent: 'Premium package',
    eyebrow: t(1, 0, 0).replace('Premium package ', ''),
    title: t(1, 0, 2).split(' – ')[1]!,
    pricePrefix: 'Fixed price:',
    priceText: t(1, 0, 2).split(' – ')[0]!,
    href: route('fixed-implant-bridge'),
    cta: t(1, 0, 11),
    ratingAlt: ui('en').rating,
  },
  ...
  about: {
    eyebrow: t(1, 7, 0),
    ...withAccentedPhrase(t(1, 7, 2), 'expertise'),
    description: t(1, 7, 3),
  },
  testimonials: {
    eyebrow: t(1, 8, 0),
    ...withAccentedPhrase(t(1, 8, 2), 'trust'),
    description: t(1, 8, 4),
  },
  testimonialPhoto: {
  ...
  information: {
    eyebrow: t(1, 9, 0),
    ...withAccentedPhrase(t(1, 9, 2), 'interested in'),
    description: t(1, 9, 4),
  },
  informationAction: { href: '#contatti', label: t(1, 9, 29) },
...
export const informationCards = [
  ...
  title: t(1, 9, [6, 9, 12, 15, 18, 21, 24, 27][i]!),
  text: t(1, 9, [7, 10, 13, 16, 19, 22, 25, 28][i]!),
  href: route(id),
}));
