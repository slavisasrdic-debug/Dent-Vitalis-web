...
export const home = {
  ...itHome,
  metadata: {
    title: 'DentVitalis – Zobozdravniki na Hrvaškem',
    description: t(1, 6, 4)
      .split(/(?<=[.!?])\s+/)
      .slice(0, 2)
      .join(' '),
  ...
  about: {
    eyebrow: t(1, 7, 0),
    ...withAccentedPhrase(t(1, 7, 2), 'strokovno znanje'),
    description: t(1, 7, 3),
  },
  testimonials: {
    eyebrow: t(1, 8, 0),
    ...withAccentedPhrase(t(1, 8, 2), 'zaupanju'),
    description: t(1, 8, 4),
  },
  testimonialPhoto: {
  ...
  information: {
    eyebrow: t(1, 9, 0),
    ...withAccentedPhrase(t(1, 9, 2), 'zanimalo'),
    description: t(1, 9, 4),
  },
