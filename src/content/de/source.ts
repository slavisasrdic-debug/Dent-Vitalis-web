import catalogue from '../../../data/translations/de-source.json';
...
export function text(id: string): string {
  ...
  if (id === 't5.r0.c0.p10') value = 'Zahnkronen bereits ab 220 €';
...
export function row(
  ...
  return selection
    ...
    .map((part) => {
      ...
      if (!match) throw new Error(`Invalid German selection: ${part}`);
