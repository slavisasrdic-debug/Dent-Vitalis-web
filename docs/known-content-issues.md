...
## Aktualni HR status — nakon odobrenja URL-ova i pravnih izvora

Implementirano je 27 HR stranica uz 28 IT stranica. Odobreni slugovi i dva pravna teksta više nisu blokada izrade. Lokalizirani su alt/ARIA/SEO podaci, stvarni IT↔HR parovi i strukturirani podaci iz sadržaja; DE/EN/SI nisu lažno povezani. Povijesni navodi ispod o nedostatku HR odobrenja, OG-a ili schema podataka ne opisuju aktualni preview.
...
- Tada su HR slugovi i pravni izvor čekali potvrdu; naknadno su odobreni i implementirani (vidi aktualni status iznad). Backend, produkcijski SEO, pravni/medicinski pregled i uključivanje integracija ostaju zasebne odluke.
