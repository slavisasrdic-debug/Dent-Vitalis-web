...
15. rujna — provjera plaćanja: korisnik odobrio isti barkod za HR i usklađenje SWIFT-a s Erste bankom. HR sada koristi centralni `referenceBusiness.swift` ESBCHR22 kao IT (izvorni DOCX ZABAHR2X ostaje nepromijenjen). Erste potvrda: https://cdn0.erstegroup.com/content/dam/hr/ebc/www_erstebank_hr/gradani/downloads/stednja-i-investicije/investicije/Popis_trecih_osoba.pdf?forceDownload=1 . Lokalno očitan izvorni PDF417 preko zxing-cpp: HRVHUB30, EUR, iznos `000000000000001` (0,01 EUR), primatelj Dentvitalis Fides d.o.o., Krešimirova 60, Rijeka, IBAN HR1424020061100858111, model HR00, prazan poziv na broj, namjena OTHR, opis Ponuda/Preventivo. Nema SWIFT polja. IBAN se podudara s obje stranice; to nije bankovna potvrda vlasništva. HUB euro specifikacija: https://hub.hr/sites/default/files/inline-files/2DBK_EUR_Uputa_1.pdf . Zbog novootkrivenog iznosa 0,01 EUR dodavanje slike u HR zaustavljeno do odluke vlasnika; IT postojeći barkod nije mijenjan. Decoder instaliran samo u /tmp/dent-barcode-venv, bez nove projektne ovisnosti.
...
WhatsApp sada implementiran na naknadni korisnikov „Ajde napravi da riješimo to”, kao odgovor na pitanje o zajedničkom IT/HR broju. Korištenje **385911100523** za oba jezika izričito je navedeno korisniku prije rada; nije izvučeno iz Zendesk konfiguracije. `data/site.ts` je jedini broj za widget. Panel ima plavo zaglavlje, postojeći logo, HR/IT poruke iz potvrđenog javnog chata i zeleni native wa.me link. Nema lažnog online statusa, badgea, osobe ili obećanja vremena odgovora. Ne učitava Elfsight/Zendesk/WhatsApp skripte niti šalje poruku; link se otvara tek korisnikovim klikom. Raniji chat zapisi niže povijesni su i ne označuju trenutačni status.
