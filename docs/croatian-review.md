...
| Riješeno — cijene                   | Preostalih 330 € u HR Word sidebaru; talijanski ispravak i ostali HR prikazi navode od 220 €                             | Korisnik 9. rujna odobrio „Zubne krunice već od 220 €”. Jedinstvena poslovna cijena ostaje `crownPrice`; izvorni Word je sačuvan.                                  |
...
- Dopuna 9. rujna: „Dr. XY” zamijenjen je imenom iz Worda nakon korisničkog odobrenja. Isti vidljivi odlomak sada je ponovno u `Person.description`. Nije dodana izmišljena medicinska recenzija, kvalifikacija niti datum stručne provjere; Word/Webflow snapshotovi ostaju netaknuti.
