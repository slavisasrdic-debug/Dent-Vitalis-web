...
- Prije predaje lokalizacije pokrenuti `npm run test:hr`: izvorni odlomci moraju postojati na namijenjenim stranicama, uz lokalizirane alt/ARIA/SEO podatke i stvarne jezične parove. Nelogičnosti izvora voditi u jednoj listi za vlasnika, ne samovoljno ispravljati medicinske, pravne ili poslovne podatke.
